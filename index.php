...
?>
    ...
    <section class="hero" id="hero" aria-labelledby="heroTitle">
        ...
        <div class="hero-content">
            ...
            <a href="<?= url('safari/') ?>" class="hero-cta"><?= e(t('hero_cta')) ?> <?= icon('arrow-right') ?></a>
        </div>
        ...
        <div class="container">
            <div class="about-us-wrapper">
                ...
                <div class="about-us-content">
                    <span class="story-badge"><?= icon('compass') ?> <?= e(t('about_badge')) ?></span>
                    ...
                    <div class="about-us-actions">
                        ...
                        <div class="about-us-call">
                            <span class="call-icon"><?= icon('phone') ?></span>
                            <div>
            ...
            <div id="storyModalBody">
                ...
                <div class="story-content" data-story-content="leopard" hidden>
                    ...
                    <div class="guide-quote">
                        <p><?= icon('quote-left', '', 'color:#d4a843; margin-right:0.5rem;') ?> <?= e(t('story_leopard_body')) ?></p>
                    </div>
                    <p><?= e(t('story_leopard_context')) ?></p>
                    <div class="story-meta">
                        <span><?= icon('clock') ?> <?= e(t('story_leopard_meta_time')) ?></span>
                        <span><?= icon('map-pin') ?> <?= e(t('story_leopard_meta_place')) ?></span>
                        <span class="highlight-tag"><?= icon('user-tie') ?> <?= e(t('story_leopard_author')) ?></span>
                    </div>
                    <div class="story-cta">
                        <a href="<?= url('parks/serengeti-national-park.php') ?>" class="btn btn-primary btn-sm"><?= e(t('story_leopard_cta')) ?> <?= icon('arrow-right') ?></a>
                ...
                <div class="story-content" data-story-content="kilimanjaro" hidden>
                    <span class="story-badge"><?= icon('mountain') ?> <?= e(t('story_kili_badge')) ?></span>
                    <h3><?= e(t('story_kili_title')) ?></h3>
                    <p><em><?= e(t('story_kili_quote')) ?></em></p>
                    <div class="guide-quote">
                        <p><?= icon('quote-left', '', 'color:#2980b9; margin-right:0.5rem;') ?> <?= e(t('story_kili_body')) ?></p>
                    </div>
                    <p><?= e(t('story_kili_context')) ?></p>
                    <div class="story-meta">
                        <span><?= icon('clock') ?> <?= e(t('story_kili_meta_time')) ?></span>
                        <span><?= icon('map-pin') ?> <?= e(t('story_kili_meta_place')) ?></span>
                        <span class="highlight-tag"><?= icon('user-tie') ?> <?= e(t('story_kili_author')) ?></span>
                    </div>
                    <div class="story-cta">
                        <a href="<?= url('trekking/') ?>" class="btn btn-primary btn-sm"><?= e(t('story_kili_cta')) ?> <?= icon('arrow-right') ?></a>
                        <a href="https://wa.me/255697612865" class="btn btn-outline btn-sm" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> <?= e(t('story_ask_more')) ?></a>
                    </div>
                </div>

                <div class="story-content" data-story-content="maasai" hidden>
                    <span class="story-badge"><?= icon('users') ?> <?= e(t('story_maasai_badge')) ?></span>
                    <h3><?= e(t('story_maasai_title')) ?></h3>
                    <p><em><?= e(t('story_maasai_quote')) ?></em></p>
                    <div class="guide-quote">
                        <p><?= icon('quote-left', '', 'color:#d4a843; margin-right:0.5rem;') ?> <?= e(t('story_maasai_body')) ?></p>
                    </div>
                    <p><?= e(t('story_maasai_context')) ?></p>
                    <div class="story-meta">
                        <span><?= icon('clock') ?> <?= e(t('story_maasai_meta_time')) ?></span>
                        <span><?= icon('map-pin') ?> <?= e(t('story_maasai_meta_place')) ?></span>
                        <span class="highlight-tag"><?= icon('user-tie') ?> <?= e(t('story_maasai_author')) ?></span>
                    </div>
                    <div class="story-cta">
                        <a href="<?= url('day-trips/') ?>" class="btn btn-primary btn-sm"><?= e(t('story_maasai_cta')) ?> <?= icon('arrow-right') ?></a>
                        <a href="https://wa.me/255697612865" class="btn btn-outline btn-sm" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> <?= e(t('story_ask_more')) ?></a>
                    </div>
                </div>
            ...
            <div class="comparison-grid">
                ...
                <div class="comparison-card">
                    <div class="comparison-card-head">
                        <span class="comparison-icon"><?= icon('wallet') ?></span>
                        <h3><?= e(t('comparison_budget_title')) ?></h3>
                        <p class="comparison-tagline"><?= e(t('comparison_budget_tagline')) ?></p>
                    </div>
                    <ul>
                        <li><?= icon('check-circle') ?> <?= e(t('comparison_budget_1')) ?></li>
                        <li><?= icon('check-circle') ?> <?= e(t('comparison_budget_2')) ?></li>
                        <li><?= icon('check-circle') ?> <?= e(t('comparison_budget_3')) ?></li>
                ...
                <div class="comparison-card featured">
                    ...
                    <div class="comparison-card-head">
                        <span class="comparison-icon"><?= icon('gem') ?></span>
                        <h3><?= e(t('comparison_luxury_title')) ?></h3>
                        <p class="comparison-tagline"><?= e(t('comparison_luxury_tagline')) ?></p>
                    </div>
                    <ul>
                        <li><?= icon('check-circle') ?> <?= e(t('comparison_luxury_1')) ?></li>
                        <li><?= icon('check-circle') ?> <?= e(t('comparison_luxury_2')) ?></li>
                        <li><?= icon('check-circle') ?> <?= e(t('comparison_luxury_3')) ?></li>
    ...
    <section class="top-destinations-section" aria-labelledby="destinationsTitle">
        <div class="container">
            <div class="top-destinations-header">
                <div class="section-title-left centered">
                    <span class="section-badge"><?= icon('map-marked-alt') ?> <?= e(t('destinations_badge')) ?></span>
                ...
                <div class="destinations-slider-arrows">
                    <button type="button" class="stories-slider-arrow prev" id="destinationsPrev" aria-label="Previous destination"><?= icon('chevron-left') ?></button>
                    <button type="button" class="stories-slider-arrow next" id="destinationsNext" aria-label="Next destination"><?= icon('chevron-right') ?></button>
                </div>
            </div>
            ...
            <div class="destinations-slider" id="destinationsSlider">
                <div class="destinations-track" id="destinationsTrack">
                    ...
                    <a href="<?= url('parks/') ?>" class="destination-card destination-card-more">
                        <span class="destination-more-icon"><?= icon('arrow-right') ?></span>
    ...
    <section class="best-packages-section" aria-labelledby="packagesTitle">
        <div class="container">
            ...
            <div class="best-packages-slider">
                <button type="button" class="slider-nav-arrow prev" id="packagesPrev" aria-label="Previous package"><?= icon('arrow-left') ?></button>
                <button type="button" class="slider-nav-arrow next" id="packagesNext" aria-label="Next package"><?= icon('arrow-right') ?></button>
                    ...
                    <a href="<?= url('safari/') ?>" class="package-card">
                        ...
                        <div class="package-body">
                            ...
                            <div class="package-footer">
                                ...
                                <span class="package-arrow"><?= icon('arrow-right') ?></span>
                            </div>
                        </div>
                    </a>
                    <a href="<?= url('safari/') ?>" class="package-card">
            ...
            <div class="planner-chat" id="plannerChat" data-step="0">
                <div class="planner-chat-header">
                    ...
                    <div class="planner-chat-header-text">
                        ...
                        <span class="planner-chat-status"><?= icon('circle') ?> Online now</span>
                    </div>
    ...
    <section class="gallery-section" aria-labelledby="galleryTitle">
        ...
        <div class="gallery-lightbox" id="galleryLightbox" role="dialog" aria-modal="true" aria-label="Gallery image viewer" hidden>
            ...
            <button type="button" class="gallery-lightbox-nav prev" id="galleryLightboxPrev" aria-label="Previous image"><?= icon('chevron-left') ?></button>
            <figure class="gallery-lightbox-figure">
                <img loading="lazy" src="" alt="" id="galleryLightboxImg" />
                <figcaption id="galleryLightboxCaption"></figcaption>
            </figure>
            <button type="button" class="gallery-lightbox-nav next" id="galleryLightboxNext" aria-label="Next image"><?= icon('chevron-right') ?></button>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="journey-steps-grid">
                <div class="journey-step">
                    <span class="journey-step-number"><?= icon('plane-arrival') ?></span>
                    <h3><?= e(t('journey_arrival_title')) ?></h3>
                    <p><?= e(t('journey_arrival_desc')) ?></p>
                </div>
                <div class="journey-step">
                    <span class="journey-step-number"><?= icon('compass') ?></span>
                ...
                <div class="journey-step">
                    <span class="journey-step-number"><?= icon('users') ?></span>
                    <h3><?= e(t('journey_people_title')) ?></h3>
                    <p><?= e(t('journey_people_desc')) ?></p>
                </div>
                <div class="journey-step">
                    <span class="journey-step-number"><?= icon('gem') ?></span>
                    <h3><?= e(t('journey_luxury_title')) ?></h3>
                    <p><?= e(t('journey_luxury_desc')) ?></p>
                </div>
                <div class="journey-step">
                    <span class="journey-step-number"><?= icon('clipboard-list') ?></span>
                    <h3><?= e(t('journey_planning_title')) ?></h3>
                    <p><?= e(t('journey_planning_desc')) ?></p>
                </div>
                <div class="journey-step">
                    <span class="journey-step-number"><?= icon('check-circle') ?></span>
                    <h3><?= e(t('journey_booking_title')) ?></h3>
                    <p><?= e(t('journey_booking_desc')) ?></p>
                </div>
                <div class="journey-step">
                    <span class="journey-step-number"><?= icon('star') ?></span>
            ...
            <div class="shorts-grid">
                ...
                <div class="short-item" data-video="MNKLVNZqHO4">
                    <div class="thumbnail-wrapper">
                        ...
                        <div class="play-btn"><?= icon('play-circle') ?></div>
                    </div>
            ...
            <div class="text-center" style="margin-top:1.5rem;">
                <a href="https://www.youtube.com/@serengetibudgetsafari" target="_blank" rel="noopener" class="btn btn-secondary"
                   style="background:#ff0000;color:#fff;padding:0.7rem 2rem;border-radius:50px;display:inline-flex;align-items:center;gap:0.6rem;text-decoration:none;transition:all 0.3s ease;">
                    <i class="fab fa-youtube"></i> <?= e(t('shorts_visit_channel')) ?> <?= icon('arrow-right') ?>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="final-cta-emotional" id="booking" aria-labelledby="finalCtaTitle">
        <div class="container">
            <div class="final-cta-content centered">
                ...
                <div class="btn-group">
                    <a href="<?= url('contact.php') ?>" class="btn btn-primary btn-lg"><?= e(t('final_cta_request')) ?> <?= icon('arrow-right') ?></a>
