...
$page = 'safari';
$altPath = 'safari/grumeti-river-migration-safari.php';
$pageMetaTitle = 'mig3_meta_title';
$pageMetaDescription = 'mig3_meta_description';
...
$P = 'mig3';
$optionCount = 5;
$optionDays = [1 => 5, 2 => 6, 3 => 5, 4 => 5, 5 => 4];
?>
        ...
        <section class="detail-section" style="padding-top:1.6rem;padding-bottom:3.5rem;">
            <div class="container">
                ...
                <div class="tour-gallery">
                    <a class="tour-gallery-main" href="<?= asset('images/gallery/tourists-watching-hippos-river.jpg') ?>" target="_blank" rel="noopener">
                        <img src="<?= asset('images/gallery/tourists-watching-hippos-river.jpg') ?>" alt="<?= e(t($P . '_hero_title')) ?>" loading="lazy" />
                    </a>
                    <div class="tour-gallery-side">
                        <a href="<?= asset('images/wildlife/zebra-herd-grazing-savanna.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/wildlife/zebra-herd-grazing-savanna.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
                        </a>
                        <a href="<?= asset('images/wildlife/leopard-tree-branch-close-up.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/wildlife/leopard-tree-branch-close-up.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
                        </a>
                        <a href="<?= asset('images/hero/elephant-close-up-portrait.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/hero/elephant-close-up-portrait.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
