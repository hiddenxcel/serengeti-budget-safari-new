...
$page = 'safari';
$altPath = 'safari/mara-river-crossing-safari.php';
$pageMetaTitle = 'mig4_meta_title';
$pageMetaDescription = 'mig4_meta_description';
...
$P = 'mig4';
$optionCount = 5;
$optionDays = [1 => 4, 2 => 5, 3 => 6, 4 => 5, 5 => 4];
?>
            ...
            <div class="container">
                ...
                <div class="tour-gallery">
                    <a class="tour-gallery-main" href="<?= asset('images/wildlife/lion-pride-zebra-kill.jpg') ?>" target="_blank" rel="noopener">
                        <img src="<?= asset('images/wildlife/lion-pride-zebra-kill.jpg') ?>" alt="<?= e(t($P . '_hero_title')) ?>" loading="lazy" />
                    </a>
                    <div class="tour-gallery-side">
                        <a href="<?= asset('images/wildlife/lion-pride-stalking-zebra.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/wildlife/lion-pride-stalking-zebra.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
                        </a>
                        <a href="<?= asset('images/gallery/tourists-watching-hippos-river.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/gallery/tourists-watching-hippos-river.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
                        </a>
                        <a href="<?= asset('images/hero/male-lion-portrait-mane.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/hero/male-lion-portrait-mane.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
