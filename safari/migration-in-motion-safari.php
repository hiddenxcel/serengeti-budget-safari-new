...
$page = 'safari';
$altPath = 'safari/migration-in-motion-safari.php';
$pageMetaTitle = 'mig2_meta_title';
$pageMetaDescription = 'mig2_meta_description';
...
$P = 'mig2';
$optionCount = 5;
$optionDays = [1 => 5, 2 => 6, 3 => 5, 4 => 4, 5 => 4];
?>
            ...
            <div class="container">
                ...
                <div class="tour-gallery">
                    <a class="tour-gallery-main" href="<?= asset('images/gallery/zebras-savanna-plains.jpg') ?>" target="_blank" rel="noopener">
                        <img src="<?= asset('images/gallery/zebras-savanna-plains.jpg') ?>" alt="<?= e(t($P . '_hero_title')) ?>" loading="lazy" />
                    </a>
                    <div class="tour-gallery-side">
                        <a href="<?= asset('images/wildlife/leopard-resting-in-tree.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/wildlife/leopard-resting-in-tree.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
                        </a>
                        ...
                        <a href="<?= asset('images/wildlife/cheetah-scanning-savanna.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/wildlife/cheetah-scanning-savanna.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
