...
$page = 'safari';
$altPath = 'safari/zanzibar-serengeti-migration-safari.php';
$pageMetaTitle = 'mig5_meta_title';
$pageMetaDescription = 'mig5_meta_description';
        ...
        <section class="detail-section" style="padding-top:1.6rem;padding-bottom:3.5rem;">
            <div class="container">
                ...
                <div class="tour-gallery">
                    <a class="tour-gallery-main" href="<?= asset('images/gallery/savanna-sunrise-acacia-trees.jpg') ?>" target="_blank" rel="noopener">
                        <img src="<?= asset('images/gallery/savanna-sunrise-acacia-trees.jpg') ?>" alt="<?= e(t($P . '_hero_title')) ?>" loading="lazy" />
                    </a>
                    <div class="tour-gallery-side">
                        ...
                        <a href="<?= asset('images/hero/elephant-under-acacia-tree.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/hero/elephant-under-acacia-tree.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
                        </a>
                        <a href="<?= asset('images/wildlife/white-rhino-grazing.jpg') ?>" target="_blank" rel="noopener">
                            <img src="<?= asset('images/wildlife/white-rhino-grazing.jpg') ?>" alt="Great Migration wildlife" loading="lazy" />
